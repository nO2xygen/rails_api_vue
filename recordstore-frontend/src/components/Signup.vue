    ...
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signup">
        ...
        <div class="mb-6">
          ...
          <input type="email" v-model="email" class="input" id="email" placeholder="vkom@fun.com">
        </div>
        ...
        <button type="submit" class="font-sans font-bold px-2 rounded cursor-pointer no-underline bg-green-500 hover:bg-green-400 block w-full py-2 text-white items-center justify-center">Sign Up</button>
